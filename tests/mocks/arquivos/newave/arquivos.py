MockArquivos = [
    ...
    "RELATORIO DE CONVERGENCIA   : pmo.py\n",
    ...
    "ARQUIVO C/TEND. HIDROLOGICA : eafpast.py\n",
    ...
    "ARQUIVO DESP. ANTEC. GNL    : adterm.py\n",
