MockDger = [
    ...
    "MES INICIO DO ESTUDO   12\n",
    "ANO INICIO DO ESTUDO 2023\n",
    "No. DE ANOS PRE         0\n",
    "No. DE ANOS POS         5\n",
    ...
    "TIPO SIMUL. FINAL       1   1  NAO SIMULA; =1 S.SINT.; =2 S.HIST.; =3 CONSIST)                             \n",
    ...
    "GERACAO EOLICA          0 0.0063       SIDERA , =1 CONSIDERA)                                                 \n",
    "REST. TURBINAMENTO      1   (=0 NAO CONSIDERA , =1 CONSIDERA)                                                                                       \n",
    "REST. DEFL. MAXIMA      0   (=1 HISTORICO, =2 PARAMETROS DA D\n",
    "BASE PLS BACKWARD       1                                            \n",
    ...
    "FCF POS ESTUDO          0                 \n",
    "ESTACOES BOMBEAMENTO    0                                    \n",
    "CANAL DE DESVIO         0                                    \n",
    "REST.HID. VAZAO(RHQ)    0                                    \n",
    "REST.HID. VOLUME(RHV)   0                                    \n",
    "TRATA ARQS CORTES       1    0                                                                                                                                                                      \n",
]
